...
class ExcelData():
    ...
    # def excel_cell(self,sheetname,i,j):
    #     workbook = xlrd.open_workbook(excel_path)
    #     sheet = workbook.sheet_by_name(sheetname)
    #     return sheet.cell(i,j).value
    # @classmethod
    # def excel_nrows(self,sheetname):
    #     # 行
    #     workbook = xlrd.open_workbook(excel_path)
    #     sheet = workbook.sheet_by_name(sheetname)
    #     return int(sheet.nrows)
    # @classmethod
    # def excel_ncols(self,sheetname):
    #     #列
    #     workbook = xlrd.open_workbook(excel_path)
    #     sheet = workbook.sheet_by_name(sheetname)
    #     return int(sheet.ncols)


if __name__ == '__main__':
    file_path = "E:\\auto_task\\iLIS\data\\测试用例.xls"
    sheet_name = "登录"
